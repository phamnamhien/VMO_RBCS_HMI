...
app_state_hsm_init(DeviceHSM_t* me) {
    ...
    ESP_ERROR_CHECK(ticks_create(&blink_1s_timer, blink_1s_timer_callback, TICK_PERIODIC, me));
    ESP_ERROR_CHECK(ticks_create(&tm_loading, tm_loading_callback, TICK_PERIODIC, me));
...
app_state_loading_handler(HSM* This, HSM_EVENT event, void* param) {
    ...
    switch (event) {
        case HSME_ENTRY: ticks_start(tm_loading, 100); break;
        case HSME_INIT: break;
        case HSME_EXIT:
            loading_count = 0;
...
app_state_main_common_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        case HSME_ENTRY: break;
        case HSME_INIT: break;
        case HSME_EXIT: break;
        case HSME_MODBUS_GET_STATION_STATE_DATA:
            // Handle station state data update if needed
            break;
        case HSME_MODBUS_GET_SLOT_DATA: ui_update_all_slots_display((DeviceHSM_t*)This); break;
        case HSME_CHANGE_SCR_MAIN_TO_SETTING: HSM_Tran((HSM*)This, &app_state_setting, NULL, NULL); break;
        case HSME_MODBUS_CONNECTED: ui_show_main_not_connect(false); break;
        case HSME_MODBUS_NOTCONNECTED: ui_show_main_not_connect(true); break;
        default: return event;
    }
    return 0;
}
...
app_state_main_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        ...
        case HSME_INIT: break;
        case HSME_EXIT: break;
        case HSME_MAIN_SLOT_1_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_1, NULL, NULL); break;
        case HSME_MAIN_SLOT_2_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_2, NULL, NULL); break;
        case HSME_MAIN_SLOT_3_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_3, NULL, NULL); break;
        case HSME_MAIN_SLOT_4_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_4, NULL, NULL); break;
        case HSME_MAIN_SLOT_5_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_5, NULL, NULL); break;
        default: return event;
    }
    return 0;
}
...
app_state_main_slot_1_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        ...
        case HSME_EXIT:
            ...
            //ui_show_slot_detail_panel(false);
            break;
        case HSME_MODBUS_GET_SLOT_1_DATA: ui_update_all_slot_details((DeviceHSM_t*)This, IDX_SLOT_1); break;
        case HSME_MAIN_SLOT_1_CLICKED: HSM_Tran((HSM*)This, &app_state_main, NULL, NULL); break;
        case HSME_MAIN_SLOT_2_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_2, NULL, NULL); break;
        case HSME_MAIN_SLOT_3_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_3, NULL, NULL); break;
        case HSME_MAIN_SLOT_4_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_4, NULL, NULL); break;
        case HSME_MAIN_SLOT_5_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_5, NULL, NULL); break;
        case HSME_MAIN_MANUAL_SWAP_CLICKED: modbus_master_write_single_register(APP_MODBUS_SLAVE_ID, 1000, 1); break;
        default: return event;
    }
    return 0;
}
...
app_state_main_slot_2_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        ...
        case HSME_EXIT:
            ...
            // ui_show_slot_detail_panel(false);
            break;
        case HSME_MODBUS_GET_SLOT_2_DATA: ui_update_all_slot_details((DeviceHSM_t*)This, IDX_SLOT_2); break;
        case HSME_MAIN_SLOT_1_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_1, NULL, NULL); break;
        case HSME_MAIN_SLOT_2_CLICKED: HSM_Tran((HSM*)This, &app_state_main, NULL, NULL); break;
        case HSME_MAIN_SLOT_3_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_3, NULL, NULL); break;
        case HSME_MAIN_SLOT_4_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_4, NULL, NULL); break;
        case HSME_MAIN_SLOT_5_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_5, NULL, NULL); break;
        case HSME_MAIN_MANUAL_SWAP_CLICKED: modbus_master_write_single_register(APP_MODBUS_SLAVE_ID, 1001, 1); break;
        default: return event;
    }
    return 0;
}
...
app_state_main_slot_3_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        ...
        case HSME_EXIT:
            ...
            // ui_show_slot_detail_panel(false);
            break;
        case HSME_MODBUS_GET_SLOT_3_DATA: ui_update_all_slot_details((DeviceHSM_t*)This, IDX_SLOT_3); break;
        case HSME_MAIN_SLOT_1_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_1, NULL, NULL); break;
        case HSME_MAIN_SLOT_2_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_2, NULL, NULL); break;
        case HSME_MAIN_SLOT_3_CLICKED: HSM_Tran((HSM*)This, &app_state_main, NULL, NULL); break;
        case HSME_MAIN_SLOT_4_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_4, NULL, NULL); break;
        case HSME_MAIN_SLOT_5_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_5, NULL, NULL); break;
        case HSME_MAIN_MANUAL_SWAP_CLICKED: modbus_master_write_single_register(APP_MODBUS_SLAVE_ID, 1002, 1); break;
        default: return event;
    }
    return 0;
}
...
app_state_main_slot_4_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        ...
        case HSME_EXIT:
            ...
            // ui_show_slot_detail_panel(false);
            break;
        case HSME_MODBUS_GET_SLOT_4_DATA: ui_update_all_slot_details((DeviceHSM_t*)This, IDX_SLOT_4); break;
        case HSME_MAIN_SLOT_1_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_1, NULL, NULL); break;
        case HSME_MAIN_SLOT_2_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_2, NULL, NULL); break;
        case HSME_MAIN_SLOT_3_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_3, NULL, NULL); break;
        case HSME_MAIN_SLOT_4_CLICKED: HSM_Tran((HSM*)This, &app_state_main, NULL, NULL); break;
        case HSME_MAIN_SLOT_5_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_5, NULL, NULL); break;
        case HSME_MAIN_MANUAL_SWAP_CLICKED: modbus_master_write_single_register(APP_MODBUS_SLAVE_ID, 1003, 1); break;
        default: return event;
    }
    return 0;
}
...
app_state_main_slot_5_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        ...
        case HSME_EXIT:
            ...
            // ui_show_slot_detail_panel(false);
            break;
        case HSME_MODBUS_GET_SLOT_5_DATA: ui_update_all_slot_details((DeviceHSM_t*)This, IDX_SLOT_5); break;
        case HSME_MAIN_SLOT_1_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_1, NULL, NULL); break;
        case HSME_MAIN_SLOT_2_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_2, NULL, NULL); break;
        case HSME_MAIN_SLOT_3_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_3, NULL, NULL); break;
        case HSME_MAIN_SLOT_4_CLICKED: HSM_Tran((HSM*)This, &app_state_main_slot_4, NULL, NULL); break;
        case HSME_MAIN_SLOT_5_CLICKED: HSM_Tran((HSM*)This, &app_state_main, NULL, NULL); break;
        case HSME_MAIN_MANUAL_SWAP_CLICKED: modbus_master_write_single_register(APP_MODBUS_SLAVE_ID, 1004, 1); break;
        default: return event;
    }
    return 0;
}
...
app_state_setting_handler(HSM* This, HSM_EVENT event, void* param) {
    switch (event) {
        ...
        case HSME_INIT: break;
        case HSME_EXIT: break;
        case HSME_CHANGE_SCR_SETTING_TO_MAIN: HSM_Tran((HSM*)This, &app_state_main, NULL, NULL); break;
        default: return event;
    }
    return 0;
}
...
static void
tm_loading_callback(void* arg) {
    HSM* This = (HSM*)arg;
    HSM_Run(This, HSME_LOADING_COUNT_TIMER, NULL);
}

static void
blink_1s_timer_callback(void* arg) {
    HSM* This = (HSM*)arg;
