...
ui_update_all_slot_details(app_state_hsm_t* me, uint8_t slot_index) {
    ...
    //                        : (!chg_on && dsg_on) ? (pdsg_on ? "PDSG" : "DSG")
    //                                              : "ERROR";
    ...
    // lv_label_set_text(ui_lbMainSlotSinParValue, bms->single_parallel == 0 ? "SINGLE" : "PARALLEL");
    ...
    // lv_obj_t* cells[] = {ui_lbMainSlotCell1Value,  ui_lbMainSlotCell2Value,  ui_lbMainSlotCell3Value,
...
void
ui_clear_all_slot_details(void) {
    // if (!ui_lock(-1)) {
    //     ESP_LOGE(TAG, "Failed to lock UI");
    //     return;
    // }
...
ui_update_main_slot_voltage(app_state_hsm_t* me, int8_t slot_index) {
    ...
    // lv_obj_t* labels[] = {ui_lbMainVoltageSlot1, ui_lbMainVoltageSlot2, ui_lbMainVoltageSlot3, ui_lbMainVoltageSlot4,
...
ui_update_main_battery_percent(app_state_hsm_t* me, uint8_t slot_index) {
    ...
    // lv_obj_t* bars[] = {ui_barMainBatPercent1, ui_barMainBatPercent2, ui_barMainBatPercent3, ui_barMainBatPercent4,
    //                     ui_barMainBatPercent5};

    // lv_obj_t* soc_labels[] = {ui_lbMainSlot1SOC, ui_lbMainSlot2SOC, ui_lbMainSlot3SOC, ui_lbMainSlot4SOC,
    //                           ui_lbMainSlot5SOC};

    // lv_obj_t* warn_imgs[] = {ui_imgMainBatWarn1, ui_imgMainBatWarn2, ui_imgMainBatWarn3, ui_imgMainBatWarn4,
    //                          ui_imgMainBatWarn5};
    ...
    //         lv_obj_set_style_text_color(soc_labels[slot_index], lv_color_hex(COLOR_ERROR),
    ...
    //                 color = COLOR_CHARGE;
    //                 break;
    //             default: color = COLOR_STANDBY; break;
    //         }
    //     }

    //     // ✅ ÁP DỤNG MÀU CHO BAR (indicator)
    //     lv_obj_set_style_bg_color(bars[slot_index], lv_color_hex(color), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    //     // ✅ ÁP DỤNG MÀU CHO PERCENT LABEL
    //     lv_obj_set_style_text_color(soc_labels[slot_index], lv_color_hex(color), LV_PART_MAIN | LV_STATE_DEFAULT);
    // }
...
ui_update_main_slot_capacity(app_state_hsm_t* me, int8_t slot_index) {
    ...
    // lv_obj_t* labels[] = {ui_lbMainCapSlot1, ui_lbMainCapSlot2, ui_lbMainCapSlot3, ui_lbMainCapSlot4,
    //                       ui_lbMainCapSlot5};
...
void
ui_show_slot_serial_detail(uint8_t slot_num) {
    ...
    // lv_obj_t* slots[] = {ui_imgMainSlotSerialDetail1, ui_imgMainSlotSerialDetail2, ui_imgMainSlotSerialDetail3,
    //                      ui_imgMainSlotSerialDetail4, ui_imgMainSlotSerialDetail5};
...
void
ui_show_slot_detail_panel(bool show) {
...
void
ui_show_main_not_connect(bool show) {
    // static bool last_state = false;
    // if (show == last_state) {
    //     return; // Skip nếu không đổi
    // }
...
ui_update_all_slots_display(app_state_hsm_t* me) {
    ...
    // lv_obj_t* voltage_labels[] = {ui_lbMainVoltageSlot1, ui_lbMainVoltageSlot2, ui_lbMainVoltageSlot3,
    //                               ui_lbMainVoltageSlot4, ui_lbMainVoltageSlot5};

    // lv_obj_t* capacity_labels[] = {ui_lbMainCapSlot1, ui_lbMainCapSlot2, ui_lbMainCapSlot3, ui_lbMainCapSlot4,
    //                                ui_lbMainCapSlot5};

    // lv_obj_t* battery_bars[] = {ui_barMainBatPercent1, ui_barMainBatPercent2, ui_barMainBatPercent3,
    //                             ui_barMainBatPercent4, ui_barMainBatPercent5};

    // lv_obj_t* soc_labels[] = {ui_lbMainSlot1SOC, ui_lbMainSlot2SOC, ui_lbMainSlot3SOC, ui_lbMainSlot4SOC,
    //                           ui_lbMainSlot5SOC};

    // lv_obj_t* warn_images[] = {ui_imgMainBatWarn1, ui_imgMainBatWarn2, ui_imgMainBatWarn3, ui_imgMainBatWarn4,
    //                            ui_imgMainBatWarn5};
    ...
    //         lv_obj_set_style_bg_color(battery_bars[i], lv_color_hex(color), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    //         // Apply color to SOC label
    //         lv_obj_set_style_text_color(soc_labels[i], lv_color_hex(color), LV_PART_MAIN | LV_STATE_DEFAULT);
    //     }
    // }
