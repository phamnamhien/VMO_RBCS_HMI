...
bool
ui_support_init(void* lvgl_mutex) {
    if (lvgl_mutex == NULL) {
...
bool
ui_load_screen(lv_obj_t* screen) {
    if (screen == NULL) {
...
bool
ui_load_screen_fade(lv_obj_t* screen, uint32_t fade_time, uint32_t delay) {
    if (screen == NULL) {
        ESP_LOGE(TAG, "Screen is NULL");
        return false;
    }
...
bool
ui_load_screen_slide(lv_obj_t* screen, lv_scr_load_anim_t anim_type, uint32_t time, uint32_t delay) {
    if (screen == NULL) {
        ESP_LOGE(TAG, "Screen is NULL");
        return false;
    }
...
bool
ui_label_set_text(lv_obj_t* label, const char* text) {
...
bool
ui_label_set_text_fmt(lv_obj_t* label, const char* fmt, ...) {
...
bool
ui_image_set_src(lv_obj_t* img, const void* src) {
...
bool
ui_arc_set_value(lv_obj_t* arc, int16_t value) {
    if (arc == NULL) {
...
bool
ui_bar_set_value(lv_obj_t* bar, int32_t value, bool anim) {
    if (bar == NULL) {
...
bool
ui_slider_set_value(lv_obj_t* slider, int32_t value, bool anim) {
    if (slider == NULL) {
...
bool
ui_object_set_visible(lv_obj_t* obj, bool visible) {
    if (obj == NULL) {
...
bool
ui_object_set_enabled(lv_obj_t* obj, bool enabled) {
    if (obj == NULL) {
        ESP_LOGE(TAG, "Object is NULL");
        return false;
    }
...
static void
ui_timer_callback_wrapper(lv_timer_t* timer) {
...
bool
ui_execute_callback(ui_callback_t callback, void* user_data) {
    if (callback == NULL) {
...
void
ui_set_button_color(lv_obj_t* button, uint32_t color) {
    if (button == NULL) {
